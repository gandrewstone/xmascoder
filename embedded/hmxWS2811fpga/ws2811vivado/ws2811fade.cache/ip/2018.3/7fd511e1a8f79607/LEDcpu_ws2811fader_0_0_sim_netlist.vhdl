...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ws2811fader is
  ...
  signal colorData_reg_i_6_n_0 : STD_LOGIC;
  signal colorData_reg_i_7_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of colorData_reg_i_7 : label is "soft_lutpair8";
...
colorData_reg_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => Q(0),
      I2 => colorData_reg_i_6_n_0,
      I3 => colorData_reg_i_7_n_0,
      I4 => bitNum(3),
      I5 => bitNum(4),
      O => \interBitClk_reg[2]_0\
    );
colorData_reg_i_6: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \interBitClk_reg__0\(3),
      I5 => \interBitClk_reg__0\(6),
      O => colorData_reg_i_6_n_0
    );
colorData_reg_i_7: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
colorData_reg: unisim.vcomponents.RAMB36E1
    generic map(
      ...
      WRITE_WIDTH_B => 36
        ...
        port map (
      ADDRARDADDR(15) => '1',
      ADDRARDADDR(14) => p_1_in(9),
      ADDRARDADDR(13) => p_1_in(9),
      ADDRARDADDR(12) => p_1_in(9),
      ADDRARDADDR(11) => p_1_in(9),
      ADDRARDADDR(10) => p_1_in(9),
      ADDRARDADDR(9) => p_1_in(9),
      ADDRARDADDR(8) => p_1_in(9),
      ADDRARDADDR(7) => p_1_in(9),
      ADDRARDADDR(6) => colorData_reg_i_4_n_0,
      ADDRARDADDR(5) => p_1_in(0),
...
colorData_reg_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
colorData_reg_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
colorData_reg_i_5: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
