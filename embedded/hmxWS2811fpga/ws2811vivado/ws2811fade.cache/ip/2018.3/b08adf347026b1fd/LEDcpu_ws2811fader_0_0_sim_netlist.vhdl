...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ws2811fader is
  port (
    ...
    \interBitClk_reg[2]_0\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ws2811fader is
  ...
  signal colorData_reg_i_3_n_0 : STD_LOGIC;
  signal colorData_reg_i_4_n_0 : STD_LOGIC;
  ...
  signal \curLed[9]_i_7_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \bitNum[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \bitNum[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \bitNum[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \bitNum[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \bitNum[4]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \bitNum[4]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of colorData_reg_i_4 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \curLed[5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \curLed[6]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \curLed[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \curLed[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \curLed[9]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \curLed[9]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \interBitClk[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \interBitClk[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \interBitClk[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \interBitClk[3]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of ws2811data_INST_0_i_11 : label is "soft_lutpair6";
begin
...
\bitNum[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\bitNum[4]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
colorData_reg_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => Q(0),
      I2 => colorData_reg_i_3_n_0,
      I3 => colorData_reg_i_4_n_0,
      I4 => bitNum(3),
      I5 => bitNum(4),
      O => \interBitClk_reg[2]_0\
    );
colorData_reg_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \interBitClk_reg__0\(3),
      I5 => \interBitClk_reg__0\(6),
      O => colorData_reg_i_3_n_0
    );
colorData_reg_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\curLed[9]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\curLed[9]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFDFFFFF"
    )
        port map (
...
\curLed[9]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
        ...
        port map (
      I0 => \^curled_reg[9]_0\(5),
      I1 => \^curled_reg[9]_0\(6),
      I2 => \^curled_reg[9]_0\(8),
      I3 => \curLed[9]_i_7_n_0\,
      O => \curLed[9]_i_5_n_0\
    );
\curLed[9]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFFFFFFFFFF"
    )
        port map (
...
\curLed[9]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1FFF"
    )
        port map (
...
\interBitClk[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \interBitClk_reg__0\(3),
      I2 => \interBitClk_reg__0\(2),
      I3 => \bitNum[4]_i_4_n_0\,
      I4 => state_reg_n_0,
      I5 => Q(0),
      O => \interBitClk[6]_i_1_n_0\
    );
\interBitClk[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9AAA"
    )
        port map (
...
ws2811data_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => bitNum(4),
      I2 => bitNum(3),
      I3 => ws2811data_INST_0_i_2_n_0,
      I4 => ws2811data_INST_0_i_3_n_0,
      I5 => ws2811data_INST_0_i_4_n_0,
      O => ws2811data
    );
ws2811data_INST_0_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5555DF555555D555"
    )
        port map (
      I0 => \interBitClk_reg__0\(5),
      I1 => ws2811data_INST_0_i_5_n_0,
      I2 => bitNum(2),
      I3 => bitNum(3),
      I4 => bitNum(4),
      I5 => ws2811data_INST_0_i_6_n_0,
...
ws2811data_INST_0_i_11: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
ws2811data_INST_0_i_2: unisim.vcomponents.MUXF7
     port map (
      I0 => ws2811data_INST_0_i_7_n_0,
      I1 => ws2811data_INST_0_i_8_n_0,
      O => ws2811data_INST_0_i_2_n_0,
      S => bitNum(2)
    );
ws2811data_INST_0_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00B80000"
    )
        port map (
      I0 => ws2811data_INST_0_i_9_n_0,
      I1 => bitNum(2),
      I2 => ws2811data_INST_0_i_10_n_0,
      I3 => bitNum(3),
      I4 => bitNum(4),
      O => ws2811data_INST_0_i_3_n_0
    );
ws2811data_INST_0_i_4: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => ws2811data_INST_0_i_11_n_0,
      I3 => \interBitClk_reg__0\(6),
      I4 => Q(0),
      I5 => state_reg_n_0,
      O => ws2811data_INST_0_i_4_n_0
    );
ws2811data_INST_0_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
ws2811data_INST_0_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
ws2811data_INST_0_i_7: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ws2811fader_v1_0_S_AXI_INTR is
  ...
  attribute SOFT_HLUTNM of \axi_arready_i_1__0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \axi_wready_i_1__0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \gen_intr_reg[0].reg_global_intr_en[0]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of intr_ack_all_i_1 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of intr_all_i_1 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \intr_counter[0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \intr_counter[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \intr_counter[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \intr_counter[3]_i_1\ : label is "soft_lutpair14";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ws2811fader_v1_0_S00_AXI is
  ...
  signal nolabel_line423_n_11 : STD_LOGIC;
...
colorData_reg_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
nolabel_line423: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ws2811fader
     port map (
      DOBDO(23 downto 0) => curCol(23 downto 0),
      Q(0) => ctrl(0),
      \curLed_reg[9]_0\(9 downto 0) => curLed(9 downto 0),
      \interBitClk_reg[2]_0\ => nolabel_line423_n_11,
